    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScanningDevices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScanningDevices_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleTransactions_ScanningDevices_ScanningDeviceId",
                        column: x => x.ScanningDeviceId,
                        principalTable: "ScanningDevices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_ScanningDeviceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScanningDevices_ApiKey",
                table: "ScanningDevices",
                column: "ApiKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ScanningDevices_StoreId",
                table: "ScanningDevices",
                column: "StoreId");
        }
